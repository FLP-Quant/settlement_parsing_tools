...
df = pd.read_excel(os.path.join(folder, '20250703_DA_Positions_raw_export.xlsx'), skiprows=4)
...
df.columns = ['A', 'B', 'Date', 'D', 'Data_vs_Header_Code', 'Hour_Ending', 'G', 
              'Asset_Name', 'Asset_Type', 'Bid_Offer_Type', 'K',
              'L', 'M', 'Cleared_MW']
...
output_file = 'processed_da_energy_positions.xlsx'
